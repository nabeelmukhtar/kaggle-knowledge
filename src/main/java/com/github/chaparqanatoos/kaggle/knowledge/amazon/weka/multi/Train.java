package com.github.chaparqanatoos.kaggle.knowledge.amazon.weka.multi;
...
public class Train {
	...
	public static void main(String[] args) throws Exception {
		...
		trainLoader.setSource(new File("data/train.arff"));
		...
		MultiClassifier multiClassifier = new MultiClassifier();
		 ...
		 NaiveBayes bfTree = new NaiveBayes();
...
//		 ft.setDebug(true);
		 ...
		 */
		SerializationHelper.write("data/amazon-multi.model", multiClassifier);
		System.out.println("Saved trained model to amazon-multi.model");
