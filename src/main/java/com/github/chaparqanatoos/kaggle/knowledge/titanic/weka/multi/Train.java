package com.github.chaparqanatoos.kaggle.knowledge.titanic.weka.multi;
...
public class Train {
	...
	public static void main(String[] args) throws Exception {
		...
		trainLoader.setSource(new File("data/titanic/train.arff"));
...
//		 
		 NaiveBayes nbTree = new NaiveBayes();
...
//		 multiClassifier.addClassifier(ft);
		 ...
		 */
		SerializationHelper.write("data/titanic/titanic-multi.model", multiClassifier);
